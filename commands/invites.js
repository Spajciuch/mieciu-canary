...
module.exports.run = async (client, message, args) => {
    ...
    let invites = await message.guild.fetchInvites().catch(error => { // This will store all of the invites into the variable
        ...
        return message.channel.send('Nie mam uprawnień do zobaczenia zaproszeń');
    ...
    const embed = new Discord.MessageEmbed()
        ...
        .addField(``, `\`\`\`${table.table(possibleInvites)}\`\`\``); // This will be the field holding the leaderboard
